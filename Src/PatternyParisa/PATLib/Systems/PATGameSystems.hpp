#ifndef PAT_Systems_PATGameSystems_H_
#define PAT_Systems_PATGameSystems_H_
...
/**
 * @brief Game systems used by PatternyParisa
 */
class PATGameSystems : public ScreenSystemsContainer
{
    public:
        /**
         * @brief Constructs the game systems for PatternyParisa
         *
         * @param screenManager Screen Manager for the game.
         */
        PATGameSystems(ScreenManager & screenManager);
